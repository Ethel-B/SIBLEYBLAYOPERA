...
namespace SIBLEYBLAYOPERA.Migrations
{
    ...
    [Migration("20230711120017_RefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIBLEYBLAYOPERA.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SIBLEYBLAYOPERA.Models.Users", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SIBLEYBLAYOPERA.Models.Bookings", b =>
                {
                    b.HasOne("SIBLEYBLAYOPERA.Models.Users", "Users")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("SIBLEYBLAYOPERA.Models.DepartmentalProcurements", b =>
                {
                    b.HasOne("SIBLEYBLAYOPERA.Models.Users", "Users")
                        .WithMany("DepartmentalProcurements")
                        .HasForeignKey("UsersId");
            ...
            modelBuilder.Entity("SIBLEYBLAYOPERA.Models.Users", b =>
                {
                    ...
                    b.Navigation("DepartmentalProcurements");

                    b.Navigation("Eventslog");

                    b.Navigation("Procurements");

                    b.Navigation("StaffLog1");

                    b.Navigation("StaffLog2");

                    b.Navigation("TaxExpendituresLog");
                });
