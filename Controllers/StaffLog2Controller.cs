...
namespace SIBLEYBLAYOPERA.Controllers
{
    ...
    public class StaffLog2Controller : ControllerBase
    {
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(firstname);
            if (result is null)
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(middlename);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(lastname);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(dateofbirth);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(address);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(department);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(telephone);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(roletitle);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(staffidnumber);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(contractagreement);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(contractagreementexpiration);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(grosswage);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(netwage);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(modeofpayment);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(ewageaccountnumber);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(netwageaccounting);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(socialsecurityaddress);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(socialsecuritywage);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(socialsecuritymodeofpayment);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(socialsecurityewageaccountnumber);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(socialsecuritywageaccounting);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(vacationdays);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(numberofexhaustedvacationdays);
            if (result is null)
                return NotFound("Log not found.");
        ...
        {
            var result = await _staffLog2Service.GetSingleLog(numberofunexhaustedvacationdays);
            if (result is null)
                return NotFound("Log not found.");
